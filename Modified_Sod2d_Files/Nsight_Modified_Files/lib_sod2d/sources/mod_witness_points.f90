...
contains
   subroutine read_points(fname, np, xyz)
      ...
      call nvtxStartRange('read_points: CPU-DATA')
   ...
   subroutine isocoords(elpoints, wit, atoIJK, xi, isinside, Niwit)
      ...
      call nvtxStartRange('isocoords: CPU-DATA')
      xi_0(:) = 0
      xi(:)   = xi_0(:)
      isinside = .false.
      call nvtxEndRange()
      ...
      do ii = 1, maxite
         call nvtxStartRange('isocoords: hex_highorder')
         ...
         call nvtxStartRange('isocoords: CPU-COMPUTE')
         do ip = 1, nnode
   ...
   subroutine wit_interpolation(xiwit,elvalues,N,witval)
      ...
      witval = 0.0_rp
      call nvtxStartRange('wit_interpolation: var_interpolate')
