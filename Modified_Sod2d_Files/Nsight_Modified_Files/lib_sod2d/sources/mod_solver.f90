...
contains
   ...
   subroutine lumped_solver_scal(npoin,npoin_w,lpoin_w,Ml,R)
      ...
      call nvtxStartRange('lumped_solver_scal: GPU-COMPUTE')
      !$acc parallel loop
      do ipoin = 1,npoin_w
   ...
   subroutine lumped_solver_vect(npoin,npoin_w,lpoin_w,Ml,R)
      ...
      call nvtxStartRange('lumped_solver_vect: GPU-COMPUTE')
   ...
   subroutine conjGrad_imex(fact,igtime,save_logFile_next,noBoundaries,dt,nelem,npoin,npoin_w,nboun,numBoundsWM,connec,lpoin_w,invAtoIJK,gmshAtoI,gmshAtoJ,gmshAtoK,&
      ...
      if (flag_cg_mem_alloc_vars .eqv. .true.) then
         call nvtxStartRange('conjGrad_imex: CPU-DATA')
         ...
         call nvtxStartRange('conjGrad_imex: GPU-DATA')
      ...
      ! Initialize solver
      !
      call nvtxStartRange('conjGrad_imex: GPU-COMPUTE')
      !$acc parallel loop
      do ipoin = 1,npoin
         !$acc loop seq
         do ivars = 1,nvars
      ...
      call nvtxStartRange('conjGrad_imex: full_diffusion_ijk')
      ...
      call nvtxStartRange('conjGrad_imex: mpi_halo_atomic_update_real')
      ...
      call nvtxStartRange('conjGrad_imex: MPI_Allreduce')
