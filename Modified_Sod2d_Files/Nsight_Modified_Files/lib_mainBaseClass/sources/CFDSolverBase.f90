...
contains
   ...
   subroutine CFDSolverBase_printDt(this)
      ...
      call nvtxStartRange('CFDSolverBase_printDt: CPU-DATA')
      write(*,*) " Dt ",this%dt
      call nvtxEndRange()
   ...
   subroutine CFDSolverBase_printAll(this)
      ...
      call nvtxStartRange('CFDSolverBase_printAll: CPU-DATA')
      call this%printDt()
      call nvtxEndRange()
   ...
   subroutine CFDSolverBase_initializeSourceTerms(this)
      ...
      call nvtxStartRange('CFDSolverBase_initializeSourceTerms: CPU-DATA')
      allocate(source_term(numNodesRankPar,ndime))
      call nvtxEndRange()

      call nvtxStartRange('CFDSolverBase_initializeSourceTerms: GPU-DATA')
   ...
   subroutine CFDSolverBase_initNSSolver(this)
      ...
      if(flag_implicit == 1) then
         if (implicit_solver == implicit_solver_imex) then
            call nvtxStartRange('CFDSolverBase_initNSSolver: init_imex_solver')
            call init_imex_solver(numNodesRankPar)
            call nvtxEndRange()
         end if
      else
         call nvtxStartRange('CFDSolverBase_initNSSolver: init_rk4_solver')
   ...
   subroutine CFDSolverBase_endNSSolver(this)
      ...
      if(flag_implicit == 1) then
         if (implicit_solver == implicit_solver_imex) then
            call nvtxStartRange('CFDSolverBase_endNSSolver: end_imex_solver')
            call end_imex_solver()
            call nvtxEndRange()
         end if
      else
         call nvtxStartRange('CFDSolverBase_endNSSolver: end_rk4_solver')
         call end_rk4_solver()
         call nvtxEndRange()
      end if
   ...
   subroutine CFDSolverBase_initializeDefaultParameters(this)
      ...
      call nvtxStartRange('CFDSolverBase_initializeDefaultParameters: CPU-DATA')
...
!--------------------------------------------------------------------------------------------------------------------------
   ...
   subroutine CFDSolverBase_add_nodeScalarField2save(this,fieldSaveName,array2save)
      ...
      call nvtxStartRange('CFDSolverBase_add_nodeScalarField2save: CPU-DATA')
...
!--------------------------------------------------------------------------------------------------------------------------
   ...
   subroutine CFDSolverBase_add_nodeVectorField2save(this,fieldSaveName,array2save)
      ...
      call nvtxStartRange('CFDSolverBase_add_nodeVectorField2save: CPU-DATA')
...
!--------------------------------------------------------------------------------------------------------------------------
   ...
   subroutine CFDSolverBase_add_elemGpScalarField2save(this,fieldSaveName,array2save)
      ...
      call nvtxStartRange('CFDSolverBase_add_elemGpScalarField2save: CPU-DATA')
   ...
   subroutine CFDSolverBase_add_avgNodeScalarField2save(this,fieldSaveName,array2save)
      ...
      call nvtxStartRange('CFDSolverBase_add_avgNodeScalarField2save: CPU-DATA')
...
!--------------------------------------------------------------------------------------------------------------------------
   ...
   subroutine CFDSolverBase_add_avgNodeVectorField2save(this,fieldSaveName,array2save)
      ...
      call nvtxStartRange('CFDSolverBase_add_avgNodeVectorField2save: CPU-DATA')
...
!--------------------------------------------------------------------------------------------------------------------------
   ...
   subroutine CFDSolverBase_add_avgElemGpScalarField2save(this,fieldSaveName,array2save)
      ...
      call nvtxStartRange('CFDSolverBase_add_avgElemGpScalarField2save: CPU-DATA')
...
!--------------------------------------------------------------------------------------------------------------------------
   ...
   subroutine CFDSolverBase_setFields2Save(this)
      ...
      !---------   nodeScalars  -----------------------------
      !------------------------------------------------------
      call nvtxStartRange('CFDSolverBase_setFields2Save: add_nodeScalarField2save')
      ...
      !---------------  vectorScalars   -------------------------------------
      !----------------------------------------------------------------------
      call nvtxStartRange('CFDSolverBase_setFields2Save: add_nodeVectorField2save')
      ...
      !-------------    elemGpScalars   -------------------------------------
      !----------------------------------------------------------------------
      call nvtxStartRange('CFDSolverBase_setFields2Save: add_elemGpScalarField2save')
      ...
      !---------   nodeScalars  -----------------------------------
      !------------------------------------------------------------
      call nvtxStartRange('CFDSolverBase_setFields2Save: add_avgNodeScalarField2save')
      ...
      !---------------  vectorScalars   -------------------------------------
      !----------------------------------------------------------------------
      call nvtxStartRange('CFDSolverBase_setFields2Save: add_avgNodeVectorField2save')
   ...
   subroutine CFDSolverBase_openMesh(this)
      ...
      call nvtxStartRange('CFDSolverBase_openMesh: set_hdf5_meshFile_name')
      call set_hdf5_meshFile_name(this%mesh_h5_file_path,this%mesh_h5_file_name,mpi_size)
      call nvtxEndRange()

      call nvtxStartRange('CFDSolverBase_openMesh: set_hdf5_baseResultsFile_name')
      ...
      call nvtxStartRange('CFDSolverBase_openMesh: load_hdf5_meshfile')
      call load_hdf5_meshfile(nnode,npbou)
      call nvtxEndRange()


      ! init comms
      call nvtxStartRange('CFDSolverBase_openMesh: init_comms')
      call init_comms(this%useIntInComms,this%useRealInComms)
      call nvtxEndRange()

      ! init comms boundaries
      call nvtxStartRange('CFDSolverBase_openMesh: init_comms_bnd')
      call init_comms_bnd(this%useIntInComms,this%useRealInComms)
      call nvtxEndRange()

      call nvtxStartRange('CFDSolverBase_openMesh: save_surface_mesh_hdf5_file')
      if (isMeshBoundaries .and. this%saveSurfaceResults) then
         call save_surface_mesh_hdf5_file(npbou,mesh_gmsh2ij,mesh_vtk2ij)
      end if
      call nvtxEndRange()

      call nvtxStartRange('CFDSolverBase_openMesh: MPI_Barrier')
   ...
   subroutine checkIfWallModelOn(this)
      ...
      call nvtxStartRange('checkIfWallModelOn: CPU-DATA')
      this%isWallModelOn = .false.
      ...
      call nvtxStartRange('checkIfWallModelOn: GPU-DATA')
   ...
   subroutine checkIfSymmetryOn(this)
      ...
      call nvtxStartRange('checkIfSymmetryOn: CPU-DATA')
      this%isSymmetryOn = .false.
      do iBound = 1,numBoundCodes
   ...
   subroutine CFDSolverBase_normalFacesToNodes(this)
      ...
      call nvtxStartRange('CFDSolverBase_normalFacesToNodes: CPU-DATA')
      allocate(normalsAtNodes(numNodesRankPar,ndime))
      call nvtxEndRange()

      call nvtxStartRange('CFDSolverBase_normalFacesToNodes: GPU-DATA')
      ...
      call nvtxStartRange('CFDSolverBase_normalFacesToNodes: GPU-COMPUTE')
      ...
      call nvtxStartRange('CFDSolverBase_normalFacesToNodes: mpi_halo_boundary_atomic_update_real')
      ...
      call nvtxStartRange('CFDSolverBase_normalFacesToNodes: MPI_Barrier')
      call MPI_Barrier(app_comm,mpi_err)
      call nvtxEndRange()
   ...
   subroutine CFDSolverBase_boundaryFacesToNodes(this)
      ...
      call nvtxStartRange('CFDSolverBase_boundaryFacesToNodes: CPU-DATA')
      allocate(bouCodesNodesPar(numNodesRankPar))
      allocate(aux1(numNodesRankPar))
      allocate(bouCodes2BCType(numBoundCodes))
      call nvtxEndRange()

      call nvtxStartRange('CFDSolverBase_boundaryFacesToNodes: GPU-DATA')
      ...
      call nvtxStartRange('CFDSolverBase_boundaryFacesToNodes: fillBCTypes')
      ...
      call nvtxStartRange('CFDSolverBase_boundaryFacesToNodes: GPU-COMPUTE')
      !$acc parallel loop gang
      do iBound = 1,numBoundsRankPar
         !$acc loop vector
         do ipbou = 1,npbou
      ...
      call nvtxStartRange('CFDSolverBase_boundaryFacesToNodes: mpi_halo_min_boundary_update_int_iSendiRcv')
      ...
      call nvtxStartRange('CFDSolverBase_boundaryFacesToNodes: checkIfWallModelOn')
      call this%checkIfWallModelOn()
      call nvtxEndRange()

      call nvtxStartRange('CFDSolverBase_boundaryFacesToNodes: checkIfSymmetryOn')
      ...
      call nvtxStartRange('CFDSolverBase_boundaryFacesToNodes: MPI_Barrier')
      call MPI_Barrier(app_comm,mpi_err)
      call nvtxEndRange()
   ...
   subroutine CFDSolverBase_evalCharLength(this)
      ...
      call nvtxStartRange('CFDSolverBase_evalCharLength: CPU-DATA')
      allocate(helem(numElemsRankPar))
      call nvtxEndRange()

      !$acc enter data create(helem(:))
      do iElem = 1,numElemsRankPar
         call nvtxStartRange('CFDSolverBase_evalCharLength: char_length')
      ...
      call nvtxStartRange('CFDSolverBase_evalCharLength: MPI_Barrier')
      call MPI_Barrier(app_comm,mpi_err)
      call nvtxEndRange()
   ...
   subroutine CFDSolverBase_allocateVariables(this)
      ...
      !
      call nvtxStartRange('CFDSolverBase_allocateVariables: CPU-DATA')
      ...
      call nvtxStartRange('CFDSolverBase_allocateVariables: GPU-DATA')
      ...
      call nvtxStartRange('CFDSolverBase_allocateVariables: MPI_Barrier')
      call MPI_Barrier(app_comm,mpi_err)
      call nvtxEndRange()
   ...
   subroutine CFDSolverBase_evalOrLoadInitialConditions(this)
      ...
      if(this%loadRestartFile) then
         ...
         call nvtxStartRange('CFDSolverBase_evalOrLoadInitialConditions: load_hdf5_restartFile')
         ...
         call nvtxStartRange('CFDSolverBase_evalOrLoadInitialConditions: GPU-DATA')
         if((flag_les.eq.0).and.(flag_les_ilsa.eq.0)) then
            !$acc kernels
            mu_sgs(:,:) = 0._rp
            !$acc end kernels
         end if
         !$acc update device(mu_sgs(:,:))
         call nvtxEndRange()
         
         if(mpi_rank.eq.0) write(111,*) "   --| Loaded results for iStep",this%load_step,"time",this%time

         call nvtxStartRange('CFDSolverBase_evalOrLoadInitialConditions: eval_vars_after_load_hdf5_resultsFile')
         call this%eval_vars_after_load_hdf5_resultsFile()
         call nvtxEndRange()

         if(this%continue_oldLogs) then
            call nvtxStartRange('CFDSolverBase_evalOrLoadInitialConditions: CPU-DATA')
            ...
            if(this%loadAvgFile) then
               ...
               call nvtxStartRange('CFDSolverBase_evalOrLoadInitialConditions: load_avgResults_hdf5_file')
         ...
         call nvtxStartRange('CFDSolverBase_evalOrLoadInitialConditions: evalInitialConditions')
         call this%evalInitialConditions()
         call nvtxEndRange()
      end if

      call nvtxStartRange('CFDSolverBase_evalOrLoadInitialConditions: MPI_Barrier')
      call MPI_Barrier(app_comm,mpi_err)
      call nvtxEndRange()
   ...
   subroutine CFDSolverBase_evalInitialViscosity(this)
      ...
      if (flag_real_diff == 1) then
         if (flag_diff_suth == 0) then
            call nvtxStartRange('CFDSolverBase_evalInitialViscosity: constant_viscosity')
            call constant_viscosity(numNodesRankPar,incomp_viscosity,mu_fluid)
            call nvtxEndRange()
         else
            call nvtxStartRange('CFDSolverBase_evalInitialViscosity: sutherland_viscosity')
            call sutherland_viscosity(numNodesRankPar,Tem(:,2),mu_factor,mu_fluid)
            call nvtxEndRange()
         end if
      else if (flag_real_diff == 0) then
         call nvtxStartRange('CFDSolverBase_evalInitialViscosity: GPU-DATA')
         !$acc kernels
         mu_fluid(:) = 0.0_rp
         !$acc end kernels
         call nvtxEndRange()
      ...
      call nvtxStartRange('CFDSolverBase_evalInitialViscosity: MPI_Barrier')
      call MPI_Barrier(app_comm,mpi_err)
      call nvtxEndRange()
   ...
   subroutine CFDSolverBase_evalViscosityFactor(this)
      ...
      ! flag_mu_factor
      call nvtxStartRange('CFDSolverBase_evalViscosityFactor: GPU-COMPUTE')
      !$acc parallel loop
      do iNodeL = 1,numNodesRankPar
   ...
   subroutine eval_initial_mu_sgs(this)
      ...
      if(flag_les_ilsa == 1) then
         ...
         call nvtxStartRange('eval_initial_mu_sgs: sgs_ilsa_visc')
         ...
         call nvtxStartRange('eval_initial_mu_sgs: sgs_visc')
   ...
   subroutine CFDSolverBase_evalInitialDt(this)
      ...
      if (flag_real_diff == 1) then
         call nvtxStartRange('CFDSolverBase_evalInitialDt: adapt_dt_cfl')
      ...
      call nvtxStartRange('CFDSolverBase_evalInitialDt: MPI_Barrier')
      call MPI_Barrier(app_comm,mpi_err)
      call nvtxEndRange()
   ...
   subroutine CFDSolverBase_evalDt(this)
      ...
      if (flag_real_diff == 1) then
         call nvtxStartRange('CFDSolverBase_evalDt: adapt_dt_cfl')
         call adapt_dt_cfl(numElemsRankPar,numNodesRankPar,connecParWork,helem,u(:,:,2),csound,this%cfl_conv,this%dt,this%cfl_diff,mu_fluid,mu_sgs,rho(:,2))
         call nvtxEndRange()
      else
         call nvtxStartRange('CFDSolverBase_evalDt: adapt_dt_cfl')
   ...
   subroutine CFDSolverBase_evalShapeFunctions(this)
      ...
      call nvtxStartRange('CFDSolverBase_evalShapeFunctions: CPU-DATA')
      ...
      call nvtxStartRange('CFDSolverBase_evalShapeFunctions: GPU-DATA')
      ...
      call nvtxStartRange('CFDSolverBase_evalShapeFunctions: GaussLobattoLegendre_hex')
      ...
      call nvtxStartRange('CFDSolverBase_evalShapeFunctions: GaussLobattoLegendre_qua')
      ...
      call nvtxStartRange('CFDSolverBase_evalShapeFunctions: getGaussPoints_equispaced_hex')
      call getGaussPoints_equispaced_hex(porder,ngaus,atoIJK,xgp_equi)
      call nvtxEndRange()

      call nvtxStartRange('CFDSolverBase_evalShapeFunctions: getGaussLobattoLegendre_roots')
      ...
      do igaus = 1,ngaus
         ...
         call nvtxStartRange('CFDSolverBase_evalShapeFunctions: TripleTensorProduct')
      ...
      do igaus = 1,ngaus
         ...
         t = xgp(igaus,2)
         z = xgp(igaus,3)
         call nvtxStartRange('CFDSolverBase_evalShapeFunctions: hex_highorder')
      ...
      do igaus = 1,npbou
         s = xgp_b(igaus,1)
         t = xgp_b(igaus,2)
         call nvtxStartRange('CFDSolverBase_evalShapeFunctions: quad_highorder')
      ...
      call nvtxStartRange('CFDSolverBase_evalShapeFunctions: MPI_Barrier')
      call MPI_Barrier(app_comm,mpi_err)
      call nvtxEndRange()
   ...
   subroutine CFDSolverBase_evalBoundaryNormals(this)
      ...
      if (isMeshBoundaries) then
         ...
         call nvtxStartRange('CFDSolverBase_evalBoundaryNormals: CPU-DATA')
         allocate(boundNormalPar(numBoundsRankPar,ndime*npbou))
         call nvtxEndRange()

         call nvtxStartRange('CFDSolverBase_evalBoundaryNormals: GPU-DATA')
         !$acc enter data create(boundNormalPar(:,:))
         call nvtxEndRange()

         call nvtxStartRange('CFDSolverBase_evalBoundaryNormals: boundary_normals')
      ...
      call nvtxStartRange('CFDSolverBase_evalBoundaryNormals: MPI_Barrier')
      call MPI_Barrier(app_comm,mpi_err)
      call nvtxEndRange()
   ...
   subroutine CFDSolverBase_evalJacobians(this)
      ...
      call nvtxStartRange('CFDSolverBase_evalJacobians: CPU-DATA')
      allocate(He(ndime,ndime,ngaus,numElemsRankPar))
      allocate(gpvol(1,ngaus,numElemsRankPar))
      call nvtxEndRange()

      call nvtxStartRange('CFDSolverBase_evalJacobians: GPU-DATA')
      !$acc enter data create(He(:,:,:,:))
      !$acc enter data create(gpvol(:,:,:))
      call nvtxEndRange()

      call nvtxStartRange('CFDSolverBase_evalJacobians: elem_jacobian')
      call elem_jacobian(numElemsRankPar,numNodesRankPar,connecParOrig,coordPar,dNgp,wgp,gpvol,He)
      call  nvtxEndRange()

      call nvtxStartRange('CFDSolverBase_evalJacobians: GPU-COMPUTE')
      vol_rank  = 0.0
      vol_tot_d = 0.0
      ...
      call nvtxStartRange('CFDSolverBase_evalJacobians: MPI-Allreduce')
      call MPI_Allreduce(vol_rank,vol_tot_d,1,mpi_datatype_real8,MPI_SUM,app_comm,mpi_err)
      call nvtxEndRange()

      this%VolTot = real(vol_tot_d,rp)

      call nvtxStartRange('CFDSolverBase_evalJacobians: MPI-Barrier')
      call MPI_Barrier(app_comm,mpi_err)
      call nvtxEndRange()
   ...
   subroutine CFDSolverBase_evalAtoIJKInverse(this)
      ...
      call nvtxStartRange('CFDSolverBase_evalAtoIJKInverse: CPU-DATA')
      ...
      call nvtxStartRange('CFDSolverBase_evalAtoIJKInverse: GPU-DATA')
      ...
      call nvtxStartRange('CFDSolverBase_evalAtoIJKInverse: atoIJKInverse')
   ...
   subroutine CFDSolverBase_eval_elemPerNode_and_nearBoundaryNode(this)
      ...
      call nvtxStartRange('CFDSolverBase_eval_elemPerNode_and_nearBoundaryNode: CPU-DATA')
      allocate(lelpn(numNodesRankPar))
      call nvtxEndRange()

      call nvtxStartRange('CFDSolverBase_eval_elemPerNode_and_nearBoundaryNode: GPU-DATA')
      !$acc enter data create(lelpn(:))
      call nvtxEndRange()

      call nvtxStartRange('CFDSolverBase_eval_elemPerNode_and_nearBoundaryNode: elemPerNode')
      ...
      call nvtxStartRange('CFDSolverBase_eval_elemPerNode_and_nearBoundaryNode: nearBoundaryNode')
      ...
      call nvtxStartRange('CFDSolverBase_eval_elemPerNode_and_nearBoundaryNode: MPI_Barrier')
      call MPI_Barrier(app_comm,mpi_err)
      call nvtxEndRange()
   ...
   subroutine CFDSolverBase_evalMass(this)
      ...
      call nvtxStartRange("CFDSolverBase_evalMass: CPU-DATA")
      allocate(Ml(numNodesRankPar))
      call nvtxEndRange()

      call nvtxStartRange("CFDSolverBase_evalMass: GPU-DATA")
      !$acc enter data create(Ml(:))
      call nvtxEndRange()

      call nvtxStartRange("CFDSolverBase_evalMass: lumped_mass_spectral")
      ...
      do iElem = 1,numElemsRankPar
         call nvtxStartRange("CFDSolverBase_evalMass: char_length_spectral")
      ...
      call nvtxStartRange("CFDSolverBase_evalMass: MPI-Barrier")
      call MPI_Barrier(app_comm,mpi_err)
      call nvtxEndRange()
   ...
   subroutine CFDSolverBase_evalFirstOutput(this)
      ...
      call nvtxStartRange('CFDSolverBase_evalFirstOutput: saveInstResultsFiles')
      ...
      if (isMeshBoundaries) then
         do iCode = 1,numBoundCodes
            call nvtxStartRange('CFDSolverBase_evalFirstOutput: surfInfo')
      ...
      call nvtxStartRange('CFDSolverBase_evalFirstOutput: compute_fieldDerivs')
      ...
      call nvtxStartRange('CFDSolverBase_evalFirstOutput: volAvg_EK')
      call volAvg_EK(numElemsRankPar,numNodesRankPar,connecParWork,gpvol,Ngp,nscbc_rho_inf,rho(:,2),u(:,:,2),this%EK)
      call nvtxEndRange()

      call nvtxStartRange('CFDSolverBase_evalFirstOutput: visc_dissipationRate')
      ...
      call nvtxStartRange('CFDSolverBase_evalFirstOutput: maxMach')
      call maxMach(numNodesRankPar,numWorkingNodesRankPar,workingNodesPar,machno,this%maxmachno)
      call nvtxEndRange()

      call nvtxStartRange('CFDSolverBase_evalFirstOutput: write_EK')
...
20       format(6(F16.8,2X))
   ...
   subroutine CFDSolverBase_callTimeIntegration(this,istep)
      ...
      call nvtxStartRange('CFDSolverBase_callTimeIntegration: CPU-DATA')
   ...
   subroutine CFDSolverBase_saveRestartFile(this,istep)
      ...
      call nvtxStartRange('CFDSolverBase_saveRestartFile: save_hdf5_restartFile')
      ...
      call nvtxStartRange('CFDSolverBase_saveRestartFile: CPU-DATA')
   ...
   subroutine CFDSolverBase_saveAvgResultsFiles(this)
      ...
      call nvtxStartRange('CFDSolverBase_saveAvgResultsFiles: save_avgResults_hdf5_file')
      ...
      if (isMeshBoundaries .and. this%saveSurfaceResults) then
         call nvtxStartRange('CFDSolverBase_saveAvgResultsFiles: save_surface_avgResults_hdf5_file')
   ...
   subroutine CFDSolverBase_saveInstResultsFiles(this,istep)
      ...
      call nvtxStartRange('CFDSolverBase_saveInstResultsFiles: save_instResults_hdf5_file')
      ...
      if (isMeshBoundaries .and. this%saveSurfaceResults) then
         call nvtxStartRange('CFDSolverBase_saveInstResultsFiles: save_surface_instResults_hdf5_file')
   ...
   subroutine CFDSolverBase_initialBuffer(this)
      ...
      call nvtxStartRange('CFDSolverBase_initialBuffer: GPU-DATA')
      !$acc kernels
   ...
   subroutine CFDSolverBase_evalTimeIteration(this)
      ...
      call nvtxStartRange("CFDSolverBase_evalTimeIteration: MPI_Barrier")
      call MPI_Barrier(app_comm,mpi_err)
      call nvtxEndRange()
      ...
      call nvtxStartRange("CFDSolverBase_evalTimeIteration: initNSSolver")
      ...
      do istep = this%initial_istep,this%final_istep
         ...
         call nvtxStartRange("CFDSolverBase_evalTimeIteration: GPU-DATA")
         !$acc kernels
         rho(:,1) = rho(:,2)
         u(:,:,1) = u(:,:,2)
         q(:,:,1) = q(:,:,2)
         ...
         if(flag_walave) then
            ...
            !
            call nvtxStartRange("CFDSolverBase_evalTimeIteration: CPU-COMPUTE")
         ...
         call nvtxStartRange("CFDSolverBase_evalTimeIteration: callTimeIntegration")
         ...
         if(this%doTimerAnalysis) then
            call nvtxStartRange("CFDSolverBase_evalTimeIteration: MPI_Allreduce")
         ...
         if ((this%save_logFile_next==istep) .and. (this%doGlobalAnalysis)) then
            call nvtxStartRange("CFDSolverBase_evalTimeIteration: volAvg_EK")
            call volAvg_EK(numElemsRankPar,numNodesRankPar,connecParWork,gpvol,Ngp,nscbc_rho_inf,rho(:,2),u(:,:,2),this%EK)
            call nvtxEndRange()

            call nvtxStartRange("CFDSolverBase_evalTimeIteration: visc_dissipationRate")
            call visc_dissipationRate(numElemsRankPar,numNodesRankPar,connecParWork,this%leviCivi,nscbc_rho_inf,mu_fluid,mu_e,u(:,:,2),this%VolTot,gpvol,He,dNgp,this%eps_S,this%eps_D,this%eps_T)
            call nvtxEndRange()

            call nvtxStartRange("CFDSolverBase_evalTimeIteration: maxMach")
            call maxMach(numNodesRankPar,numWorkingNodesRankPar,workingNodesPar,machno,this%maxmachno)
            call nvtxEndRange()

            call nvtxStartRange("CFDSolverBase_evalTimeIteration: write_EK")
            call write_EK(this%time,this%EK,this%eps_S,this%eps_D,this%eps_T,this%maxmachno)
            call nvtxEndRange()
...
20             format(6(F16.8,2X))
         ...
         call nvtxStartRange("CFDSolverBase_evalTimeIteration: evalDt")
         call this%evalDt()
         call nvtxEndRange()

         call nvtxStartRange("CFDSolverBase_evalTimeIteration: afterDt")
         call this%afterDt(istep)
         call nvtxEndRange()

         call nvtxStartRange("CFDSolverBase_evalTimeIteration: eval_average_iter")
         ...
         call nvtxStartRange("CFDSolverBase_evalTimeIteration: surfInfo")
         ...
         call nvtxStartRange("CFDSolverBase_evalTimeIteration: saveRestartFile")
         ! ---- SAVING RESTART FILE ---------------------------------------------------------------------------
         ...
         if (this%save_resultsFile_next == istep) then
            ...
            call nvtxStartRange("CFDSolverBase_evalTimeIteration: compute_fieldDerivs")
            call compute_fieldDerivs(numElemsRankPar,numNodesRankPar,numWorkingNodesRankPar,workingNodesPar,connecParWork,lelpn,He,dNgp,this%leviCivi,dlxigp_ip,atoIJK,invAtoIJK,gmshAtoI,gmshAtoJ,gmshAtoK,rho(:,2),u(:,:,2),gradRho,curlU,divU,Qcrit)
            call nvtxEndRange()

            call nvtxStartRange("CFDSolverBase_evalTimeIteration: saveInstResultsFiles")
...
!         call this%afterDt(istep)
         ...
         if(this%have_witness) then
            if (this%continue_oldLogs) then
               if (mod(istep-this%load_step,this%leapwit)==0) then
                  iwitstep = iwitstep+1
                  call nvtxStartRange("CFDSolverBase_evalTimeIteration: update_witness")
               ...
               if ((istep-this%load_step > 0) .and. (mod((istep-this%load_step),this%leapwitsave*this%leapwit)==0)) then
                  call nvtxStartRange("CFDSolverBase_evalTimeIteration: save_witness")
      ...
      call nvtxStartRange("CFDSolverBase_evalTimeIteration: endNSSolver")
   ...
   subroutine CFDSolverBase_update_witness(this, istep, iwitstep)
      ...
      call nvtxStartRange("CFDSolverBase_update_witness: GPU-COMPUTE")
      !$acc parallel loop gang
      ...
      call nvtxStartRange("CFDSolverBase_update_witness: CPU-DATA")
   ...
   subroutine CFDSolverBase_save_witness(this, istep)
      ...
      call nvtxStartRange("CFDSolverBase_save_witness: CPU-COMPUTE")
      ...
      call nvtxStartRange("CFDSolverBase_save_witness: update_witness_hdf5")
   ...
   subroutine CFDSolverBase_preprocWitnessPoints(this)
      ...
      call nvtxStartRange("CFDSolverBase_preprocWitnessPoints: GPU-COMPUTE")
      !$acc parallel loop gang
      do ielem = 1, numElemsRankPar
         aux1   = 0.0_rp
         aux2   = 0.0_rp
      ...
      call nvtxStartRange("CFDSolverBase_preprocWitnessPoints: CPU-COMPUTE")
      ...
      call nvtxStartRange("CFDSolverBase_preprocWitnessPoints: MPI-Allreduce")
      ...
      call nvtxStartRange("CFDSolverBase_preprocWitnessPoints: GPU-DATA")
      !$acc kernels
      witGlobCand(:) = 0
      witGlob(:) = 0
      witxyzPar(:,:) = 0.0_rp
      ...
      call nvtxStartRange("CFDSolverBase_preprocWitnessPoints: read_points")
      call read_points(this%witness_inp_file_name, this%nwit, witxyz)
      call nvtxEndRange()

      call nvtxStartRange("CFDSolverBase_preprocWitnessPoints: CPU-DATA")
      do iwit = 1, this%nwit
      ...
      if (nwitFound < this%nwit) then
         ...
         call nvtxStartRange("CFDSolverBase_preprocWitnessPoints: MPI-Allgather")
      ...
      call nvtxStartRange("CFDSolverBase_preprocWitnessPoints: create_witness_hdf5")
   ...
   subroutine CFDSolverBase_loadWitnessPoints(this)
      ...
      call nvtxStartRange("CFDSolverBase_loadWitnessPoints: load_witness_hdf5")
      ...
      call nvtxStartRange("CFDSolverBase_loadWitnessPoints: CPU-DATA")
      allocate(buffwit(this%nwitPar,this%leapwitsave,this%nvarwit))
      allocate(bufftime(this%leapwitsave))
      allocate(buffstep(this%leapwitsave))
      call nvtxEndRange()
   ...
   subroutine open_log_file(this)
      ...
      call nvtxStartRange("open_log_file: CPU-DATA")
      if(mpi_rank.eq.0) then
   ...
   subroutine open_analysis_files(this)
      ...
      call nvtxStartRange("open_analysis_files: CPU-DATA")
      if(mpi_rank.eq.0) then
         write(aux_string_mpisize,'(I0)') mpi_size
...
60                format(9(3X,A,5X))
   ...
   subroutine close_log_file(this)
      ...
      call nvtxStartRange("close_log_file: CPU-DATA")
      if(mpi_rank.eq.0) then
         close(unit=111)
      end if
      call nvtxEndRange()
   ...
   subroutine close_analysis_files(this)
      ...
      call nvtxStartRange("close_analysis_files: CPU-DATA")
      if(mpi_rank.eq.0) then
   ...
   subroutine flush_log_file(this)
      ...
      call nvtxStartRange("flush_log_file: CPU-DATA")
      if(mpi_rank.eq.0) then
         flush(unit=111)
   ...
   subroutine eval_vars_after_load_hdf5_resultsFile(this)
      ...
      call nvtxStartRange("eval_vars_after_load_hdf5_resultsFile: GPU-COMPUTE")
      !$acc parallel loop
      do iNodeL = 1,numNodesRankPar
      ...
      call nvtxStartRange("eval_vars_after_load_hdf5_resultsFile: GPU-DATA")
      !$acc kernels
      kres(:) = 0.0_rp
      etot(:) = 0.0_rp
      ax1(:) = 0.0_rp
   ...
   subroutine CFDSolverBase_run(this)
      ...
      ! Init MPI
      call nvtxStartRange("CFDSolverBase_run: init_mpi")
      call init_mpi()
      call nvtxEndRange()

      ! Init HDF5 interface
      call nvtxStartRange("CFDSolverBase_run: init_hdf5_interface")
      call init_hdf5_interface()
      call nvtxEndRange()

      ! Main simulation parameters
      call nvtxStartRange("CFDSolverBase_run: initializeDefaultParameters")
      call this%initializeDefaultParameters()
      call nvtxEndRange()

      call nvtxStartRange("CFDSolverBase_run: initializeParameters")
      call this%initializeParameters()
      call nvtxEndRange()

      ! Open log file
      call nvtxStartRange("CFDSolverBase_run: open_log_file")
      call this%open_log_file()
      call nvtxEndRange()

      ! read the mesh
      call nvtxStartRange("CFDSolverBase_run: openMesh")
      call this%openMesh()
      call nvtxEndRange()

      ! Init hdf5 auxiliar saving arrays
      call nvtxStartRange("CFDSolverBase_run: init_hdf5_auxiliar_saving_arrays")
      call init_hdf5_auxiliar_saving_arrays()
      call nvtxEndRange()

      ! Open analysis files
      call nvtxStartRange("CFDSolverBase_run: open_analysis_files")
      call this%open_analysis_files()
      call nvtxEndRange()

      ! Eval shape Functions
      call nvtxStartRange("CFDSolverBase_run: evalShapeFunctions")
      call this%evalShapeFunctions()
      call nvtxEndRange()

      ! Allocate variables
      call nvtxStartRange("CFDSolverBase_run: allocateVariables")
      call this%allocateVariables()
      call nvtxEndRange()

      ! Allocating and defining filters
      call nvtxStartRange("CFDSolverBase_run: init_filters")
      call init_filters()
      call nvtxEndRange()

      ! Setting fields to be saved
      call nvtxStartRange("CFDSolverBase_run: setFields2Save")
      call this%setFields2Save()
      call nvtxEndRange()

      ! Eval or load initial conditions
      call nvtxStartRange("CFDSolverBase_run: evalOrLoadInitialConditions")
      call this%evalOrLoadInitialConditions()
      call nvtxEndRange()

      ! Init of the source terms
      call nvtxStartRange("CFDSolverBase_run: initializeSourceTerms")
      call this%initializeSourceTerms()
      call nvtxEndRange()

      ! Eval  viscosty factor
      call nvtxStartRange("CFDSolverBase_run: evalViscosityFactor")
      call this%evalViscosityFactor()
      call nvtxEndRange()

      ! Eval initial viscosty
      call nvtxStartRange("CFDSolverBase_run: evalInitialViscosity")
      call this%evalInitialViscosity()
      call nvtxEndRange()

      ! Compute characteristic size of the elements
      call nvtxStartRange("CFDSolverBase_run: evalCharLength")
      call this%evalCharLength()
      call nvtxEndRange()

      ! Eval boundary element normal
      call nvtxStartRange("CFDSolverBase_run: evalBoundaryNormals")
      call this%evalBoundaryNormals()
      call nvtxEndRange()

      ! Eval Jacobian information
      call nvtxStartRange("CFDSolverBase_run: evalJacobians")
      call this%evalJacobians()
      call nvtxEndRange()

      ! Eval AtoIJK inverse
      call nvtxStartRange("CFDSolverBase_run: evalAtoIJKInverse")
      call this%evalAtoIJKInverse()
      call nvtxEndRange()

      ! Eval BoundaryFacesToNodes
      call nvtxStartRange("CFDSolverBase_run: boundaryFacesToNodes")
      call this%boundaryFacesToNodes()
      call nvtxEndRange()

      ! Eval list Elems per Node and Near Boundary Node
      call nvtxStartRange("CFDSolverBase_run: eval_elemPerNode_and_nearBoundaryNode")
      call this%eval_elemPerNode_and_nearBoundaryNode()
      call nvtxEndRange()

      ! Eval mass
      call nvtxStartRange("CFDSolverBase_run: evalMass")
      call this%evalMass()
      call nvtxEndRange()
      ...
      if (this%have_witness) then
         if (this%continue_witness) then
            call nvtxStartRange("CFDSolverBase_run: loadWitnessPoints")
            call this%loadWitnessPoints() ! Load witness points and continue them
            call nvtxEndRange()
         else
            call nvtxStartRange("CFDSolverBase_run: preprocWitnessPoints")
      ...
      if(this%isFreshStart) then
         call nvtxStartRange("CFDSolverBase_run: evalFirstOutput")
         call this%evalFirstOutput()
         call nvtxEndRange()
      endif

      call nvtxStartRange("CFDSolverBase_run: flush_log_file")
      call this%flush_log_file()
      call nvtxEndRange()

      if(this%isWallModelOn .or. this%isSymmetryOn) then
         call nvtxStartRange("CFDSolverBase_run: normalFacesToNodes")
         call this%normalFacesToNodes()
         call nvtxEndRange()
      endif

      ! Eval initial time step
      call nvtxStartRange("CFDSolverBase_run: evalInitialDt")
      call this%evalInitialDt()
      call nvtxEndRange()

      call nvtxStartRange("CFDSolverBase_run: initialBuffer")
      ...
      call nvtxStartRange("CFDSolverBase_run: evalTimeIteration")
      call this%evalTimeIteration()
      call nvtxEndRange()

      call nvtxStartRange("CFDSolverBase_run: close_log_file")
      call this%close_log_file()
      call nvtxEndRange()

      call nvtxStartRange("CFDSolverBase_run: close_analysis_files")
      call this%close_analysis_files()
      call nvtxEndRange()

      ! Deallocate the variables
      call nvtxStartRange("CFDSolverBase_run: deallocateVariables")
      call this%deallocateVariables()
      call nvtxEndRange()

      ! Deallocate the filters
      call nvtxStartRange("CFDSolverBase_run: deallocate_filters")
      call deallocate_filters()
      call nvtxEndRange()

      ! End hdf5 auxiliar saving arrays
      call nvtxStartRange("CFDSolverBase_run: end_hdf5_auxiliar_saving_arrays")
      call end_hdf5_auxiliar_saving_arrays()
      call nvtxEndRange()

      ! End hdf5 interface
      call nvtxStartRange("CFDSolverBase_run: end_hdf5_interface")
      call end_hdf5_interface()
      call nvtxEndRange()

      ! End comms
      call nvtxStartRange("CFDSolverBase_run: end_comms")
      call end_comms()
      call nvtxEndRange()

      call nvtxStartRange("CFDSolverBase_run: end_comms_bnd")
      call end_comms_bnd()
      call nvtxEndRange()

      ! End MPI
      call nvtxStartRange("CFDSolverBase_run: end_mpi")
      call end_mpi()
      call nvtxEndRange()
