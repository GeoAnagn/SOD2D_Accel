...
contains
   ...
   subroutine TGVSolver_initializeParameters(this)
      ...
      this%maxPhysTime = 100000000000000000.0_rp
   ...
   subroutine TGVSolver_evalInitialConditions(this)
      ...
      call nvtxStartRange('TGVSolver_evalInitialConditions: CPU-DATA')
      V0 = 1.0_rp
      L  = 1.0_rp
      call nvtxEndRange()

      call nvtxStartRange('TGVSolver_evalInitialConditions: GPU-COMPUTE')
      !$acc parallel loop
      ...
      call nvtxStartRange('TGVSolver_evalInitialConditions: GPU-DATA')
      !$acc kernels
