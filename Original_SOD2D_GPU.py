...
def main():
    ...
    execute_sod2d = execute_cd + ' nsys profile -t cuda,openacc,nvtx --cuda-memory-usage=true --stats=true mpirun --allow-run-as-root'
    # Add these only if you run on Berzelius    
